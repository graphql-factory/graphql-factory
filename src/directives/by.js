...
export default {
  ...
  args: {
    resolveUser: {
      type: 'String',
      description:
        'Reference to a resolver function that returns the ' +
        'userID value. Uses a default function if omitted.',
    },
    createdByField: {
      type: 'String',
      description:
        'Argument name to use for setting the userID ' +
  ...
  resolve(source, args, context, info) {
    ...
    assert(
      isString(userID),
      'DirectiveError: @by is unable to resolve the ' +
