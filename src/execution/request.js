 ...
 *
 * Changes from official graphql-js repo
 * Added by Branden Horiuchi <bhoriuchi@gmail.com>
 *
 ...
 */
declare function requestExecution(
  ExecutionArgs,
  ..._: []
...
function getDirectiveExec (schema, constraints, variableValues) {
...
function reduceRequestDirectives (exeContext, directiveExec, source) {
...
function reduceResultDirectives (exeContext, directiveExec, source) {
  return reduceDirectives(
    exeContext,
    directiveExec,
    'resolveResult',
...
function executeOperation(
  ...
  // get the operation location based on the operation type
  ...
  // get the directives that can be applied
