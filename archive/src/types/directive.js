...
const LifecycleMap = {
  ...
  [Lifecycle.RESOLVE]: [],
  [Lifecycle.AFTER_RESOLVE]: AFTER_RESOLVE_LOCATIONS,
  [Lifecycle.AFTER_QUERY]: AFTER_RESOLVE_LOCATIONS,
  [Lifecycle.AFTER_MUTATION]: AFTER_RESOLVE_LOCATIONS,
  [Lifecycle.SUBSCRIPTION_START]: RESOLVE_LOCATIONS.concat(SUBSCRIPTION),
  [Lifecycle.SUBSCRIPTION_DATA]: AFTER_RESOLVE_LOCATIONS,
  [Lifecycle.SUBSCRIPTION_END]: RESOLVE_LOCATIONS.concat(SUBSCRIPTION),
  [Lifecycle.AFTER_REQUEST]: AFTER_RESOLVE_LOCATIONS,
